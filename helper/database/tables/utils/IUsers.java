...
public interface IUsers {
    ...
    void addUser(String name, String status, String reason, int valueGrades, boolean isHelper, boolean isMuted,
                 boolean blacklist, boolean isActiveQuestion, boolean haveCooldown) throws SQLException;
