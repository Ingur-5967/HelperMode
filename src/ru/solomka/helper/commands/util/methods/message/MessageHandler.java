...
public class MessageHandler {
    ...
    public String sSetHelper(Player p, String value) {
        String set = config.getString("Message.Helper.Rank.SetHelper").replace("%value%", value);
        return set.replace("%player%", p.getName());
    }
